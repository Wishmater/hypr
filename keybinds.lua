...
hl.bind("SUPER + SHIFT + S",   hl.dsp.exec_cmd("hyprctl dismissnotify"))
...
hl.bind("SUPER + SHIFT + code:49",   hl.dsp.exec_cmd("hyprctl dispatch toggleswallow"), { description = "Toggle swallow" }) -- tilde (`)
...
hl.bind("SUPER + CTRL + left",  hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive -" .. vars.resizeAmount .. " 0 ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + right", hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive " .. vars.resizeAmount .. " 0 ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + up",    hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive 0 " .. vars.resizeAmount .. " ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + down",  hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive 0 -" .. vars.resizeAmount .. " ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + H",     hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive -" .. vars.resizeAmount .. " 0 ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + L",     hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive " .. vars.resizeAmount .. " 0 ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + K",     hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive 0 " .. vars.resizeAmount .. " ; keyword misc:animate_manual_resizes false\""), { repeating = true })
hl.bind("SUPER + CTRL + J",     hl.dsp.exec_cmd("hyprctl --batch \"keyword misc:animate_manual_resizes true ; dispatch resizeactive 0 -" .. vars.resizeAmount .. " ; keyword misc:animate_manual_resizes false\""), { repeating = true })
